...
def main():
    print("=== Posting TBR December 2024 AR invoice ===")
    ...
    customer_id = 1
    invoice_number = "TBR-GALITOS-2024-12"
    amount = 20045.00
    ...
    header = {
        ...
        "notes": "Delivery services rendered to GALITO'S STATION for December 2024",
        "status": "approved",
    }
    ...
    lines = [{
        ...
        "item_type": "gl",
        "description": "Last-mile delivery services for December 2024",
        "account_code": "4100",
        "quantity": 1,
        "unit_price": amount,
        "discount_amount": 0,
