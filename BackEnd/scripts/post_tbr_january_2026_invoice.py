...
def main():
    print("=== Posting TBR January 2026 AR invoice ===")
    ...
    invoice_number = "TBR-GALITOS-2026-01"
    amount = 12045.00
    ...
    header = {
        ...
        "notes": "Delivery services rendered to GALITO'S STATION for January 2026",
        "status": "approved",
    }
    ...
    lines = [{
        ...
        "item_type": "gl",
        "description": "Last-mile delivery services for January 2026",
        "account_code": "4100",
        "quantity": 1,
        "unit_price": amount,
        "discount_amount": 0,
