...
def main():
    print("=== Posting TBR August 2025 AR invoice ===")
    ...
    customer_id = 1
    invoice_number = "TBR-GALITOS-2025-08"
    amount = 20780.00
    ...
    header = {
        ...
        "notes": "Delivery services rendered to GALITO'S STATION for August 2025",
        "status": "approved",
    }
    ...
    lines = [{
        ...
        "item_type": "gl",
        "description": "Last-mile delivery services for August 2025",
        "account_code": "4100",
        "quantity": 1,
        "unit_price": amount,
        "discount_amount": 0,
