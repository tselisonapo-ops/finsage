...
def main():
    print("=== Posting TBR March 2026 AR invoice ===")
    ...
    amount = float(os.getenv("MAR2026_GALITOS_INVOICE_AMOUNT", "0"))
    if amount <= 0:
        raise RuntimeError("Set MAR2026_GALITOS_INVOICE_AMOUNT because March receipt was not in company bank")

    schema = db_service.company_schema(company_id)
    invoice_number = "TBR-GALITOS-2026-03"
    ...
    header = {
        ...
        "notes": "Delivery services rendered to GALITO'S STATION for March 2026",
        "status": "approved",
    }
    ...
    lines = [{
        ...
        "item_type": "gl",
        "description": "Last-mile delivery services for March 2026",
        "account_code": "4100",
        "quantity": 1,
        "unit_price": amount,
        "discount_amount": 0,
