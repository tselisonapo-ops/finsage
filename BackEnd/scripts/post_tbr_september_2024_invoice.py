# BackEnd/scripts/post_tbr_september_2024_invoice.py
import os
import sys
import traceback
...
def main():
    print("=== Posting TBR September 2024 AR invoice ===")
    ...
    header = {
        ...
        "notes": "Delivery services rendered to GALITO'S STATION for September 2024",
        "status": "approved",
    }
    ...
    lines = [
        {
            ...
            "item_type": "gl",
            "description": "Last-mile delivery services for September 2024",
            "account_code": "4100",
            "quantity": 1,
            "unit_price": 19545.00,
            "discount_amount": 0,
