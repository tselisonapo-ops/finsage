# BackEnd/scripts/post_tbr_march_2025_invoice.py
import os, sys, traceback

def main():
    print("=== Posting TBR March 2025 AR invoice ===")
    ...
    invoice_number = "TBR-GALITOS-2025-03"
    amount = 18050.00
    ...
    header = {
        ...
        "notes": "Delivery services rendered to GALITO'S STATION for March 2025",
        "status": "approved",
    }
    ...
    lines = [{
        ...
        "item_type": "gl",
        "description": "Last-mile delivery services for March 2025",
        "account_code": "4100",
        "quantity": 1,
        "unit_price": amount,
        "discount_amount": 0,
