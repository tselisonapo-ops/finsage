...
def main():
    print("=== Posting TBR December 2025 AR invoice ===")
    ...
    invoice_number = "TBR-GALITOS-2025-12"
    amount = 12975.00
    ...
    header = {
        ...
        "notes": "Delivery services rendered to GALITO'S STATION for December 2025",
        "status": "approved",
    }
    ...
    lines = [{
        ...
        "item_type": "gl",
        "description": "Last-mile delivery services for December 2025",
        "account_code": "4100",
        "quantity": 1,
        "unit_price": amount,
        "discount_amount": 0,
