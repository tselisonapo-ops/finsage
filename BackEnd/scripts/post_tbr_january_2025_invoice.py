# BackEnd/scripts/post_tbr_january_2025_invoice.py
import os, sys, traceback

def main():
    print("=== Posting TBR January 2025 AR invoice ===")
    ...
    customer_id = 1
    invoice_number = "TBR-GALITOS-2025-01"
    amount = 17725.00
    ...
    header = {
        ...
        "notes": "Delivery services rendered to GALITO'S STATION for January 2025",
        "status": "approved",
    }
    ...
    lines = [{
        ...
        "item_type": "gl",
        "description": "Last-mile delivery services for January 2025",
        "account_code": "4100",
        "quantity": 1,
        "unit_price": amount,
        "discount_amount": 0,
