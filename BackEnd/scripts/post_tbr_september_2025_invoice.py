...
def main():
    print("=== Posting TBR September 2025 AR invoice ===")
    ...
    customer_id = 1
    invoice_number = "TBR-GALITOS-2025-09"
    amount = 11260.00
    ...
    header = {
        ...
        "notes": "Delivery services rendered to GALITO'S STATION for September 2025",
        "status": "approved",
    }
    ...
    lines = [{
        ...
        "item_type": "gl",
        "description": "Last-mile delivery services for September 2025",
        "account_code": "4100",
        "quantity": 1,
        "unit_price": amount,
        "discount_amount": 0,
