# BackEnd/scripts/post_tbr_february_2025_invoice.py
import os, sys, traceback

def main():
    print("=== Posting TBR February 2025 AR invoice ===")
    ...
    customer_id = 1
    invoice_number = "TBR-GALITOS-2025-02"
    amount = 16640.00
    ...
    header = {
        ...
        "notes": "Delivery services rendered to GALITO'S STATION for February 2025",
        "status": "approved",
    }
    ...
    lines = [{
        ...
        "item_type": "gl",
        "description": "Last-mile delivery services for February 2025",
        "account_code": "4100",
        "quantity": 1,
        "unit_price": amount,
        "discount_amount": 0,
