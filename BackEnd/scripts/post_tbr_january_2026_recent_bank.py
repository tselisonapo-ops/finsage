...
def main():
    print("=== Posting TBR January 2026 bank catch-up ===")
    ...
    lines = [
        {"account_code": "PL_ADJ_8250", "account": "Miscellaneous Adjustment", "debit": 7100.00, "credit": 0, "memo": "January ATM cash withdrawals"},
        {"account_code": "PL_COS_5004", "account": "Fuel Expense", "debit": 1150.33, "credit": 0, "memo": "January fuel purchases"},
        {"account_code": "PL_COS_5005", "account": "Vehicle Repairs & Maintenance", "debit": 2910.00, "credit": 0, "memo": "January repairs and parts"},
        {"account_code": "PL_OPEX_6800", "account": "Tracking Subscription Expense", "debit": 570.00, "credit": 0, "memo": "Ctrack debit order January"},
        {"account_code": "PL_OPEX_6105", "account": "Bank Charges", "debit": 493.81, "credit": 0, "memo": "January bank charges"},
        ...
        {"account_code": "BS_CA_1000", "account": "Cash & Bank", "debit": 0, "credit": 12224.14, "memo": "January bank payments excluding Galitos receipt"},
    ]
    ...
    entry = {
        "date": "2026-01-31",
        "ref": ref,
        "description": "January 2026 bank catch-up excluding Galitos receipt",
        "source": "bank",
        "currency": "LSL",
        "lines": lines,
    }
