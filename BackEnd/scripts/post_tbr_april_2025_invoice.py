# BackEnd/scripts/post_tbr_april_2025_invoice.py
import os, sys, traceback

def main():
    print("=== Posting TBR April 2025 AR invoice ===")
    ...
    invoice_number = "TBR-GALITOS-2025-04"
    amount = 14695.00
    ...
    header = {
        ...
        "notes": "Delivery services rendered to GALITO'S STATION for April 2025",
        "status": "approved",
    }
    ...
    lines = [{
        ...
        "item_type": "gl",
        "description": "Last-mile delivery services for April 2025",
        "account_code": "4100",
        "quantity": 1,
        "unit_price": amount,
        "discount_amount": 0,
